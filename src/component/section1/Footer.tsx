      ...
      <div className="f-main">
        ...
        <div className="contact-grid">
          <div className="f-address p-[0] group flex items-center">
                 <Image src="/assets/logo1.png" alt="Socializo Logo" width={350} height={120}  className="mx-auto filter drop-shadow-lg" />
         </div>
        ...
        <div className="py-[50px] contact-grid gap-8">
          ...
          <div className="text-center md:text-left">
            ...
            <ul className="space-y-3 list-none">
              <li className="py-[10px] ">
                 <Link  href="#"  className="text-[white] no-underline  hover:text-blue-400 transition-colors duration-300"> Home</Link>    
              </li>
          ...
          <div className="text-center md:text-left">
            ...
            <div className="flex md:flex-wrap justify-center items-center md:justify-start gap-[20px] my-[20px]">
              ...
              >
                <Image src="/assets/instagram.png" alt="" width={50} height={50} />
